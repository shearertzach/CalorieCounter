...
import { CreateFoodCatalogItemData } from '../../types';
...
export default function AddFoodModal({ isOpen, onClose, onSubmit }: AddFoodModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4 animate-fadeIn" onClick={onClose}>
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-slideInUp" onClick={(e) => e.stopPropagation()}>
        <div className="p-6">
          <h3 className="text-xl font-semibold text-gray-900 mb-6">Add New Food</h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              {showExtraNutrition && (
                <div className="mt-4 p-4 bg-gray-50 rounded-xl space-y-4 animate-slideInDown">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        Fiber (g)
